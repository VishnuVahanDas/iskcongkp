    ...
    Drupal.behaviors.bootstrap_barrio = {
        attach: function(context, settings) {
            ...
            document.addEventListener('click', function(event) {
                ...
                if (!event.target.matches('.dropdown-item a.dropdown-toggle'))
                    return;
        ...
        attach: function(context, settings) {
            jQuery(window).scroll(function() {
                if (jQuery(document).scrollTop() > 50) {
                    ...
                    jQuery(".home-menu-logo img").attr('src', '/assets/themes/contrib/akara/images/logo/iskcon_title.png');
                    jQuery(".home-menu-logo img").height('1.7rem');
                } else {
                    jQuery("#navbar-main").height('auto');
                    jQuery(".path-frontpage #main-wrapper").css
                    jQuery(".home-menu-logo img").attr('src', '/assets/themes/contrib/akara/images/logo/logo.png');
